Contributing to 2chcoin Core
============================

The 2chcoin Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/2chcoinpay/2chcoin/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the 2chcoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall 2chcoin
Network Protocol consensus changes.

Whether a pull request is merged into 2chcoin Core rests with the project merge
...
Patches that change 2chcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the 2chcoin consensus, it must have been
...
The review process is normally fairly responsive on the 2chcoin Core repository, however
...
The project leader is the release manager for each 2chcoin Core release.
