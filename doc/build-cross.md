Cross-compiliation of 2chcoin Core
===============================
...
When building 2chcoin Core, use
...
It's not possible to build the 2chcoin Core code using the win32 version of the Mingw-w64 cross compilers (at least not without
modifying headers in the 2chcoin Core source code).
