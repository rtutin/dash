UNIX BUILD NOTES
====================
Some notes on how to build 2chcoin Core in Unix.

(for OpenBSD specific instructions, see [build-openbsd.md](build-openbsd.md))

Base build dependencies
-----------------------
Building the dependencies and 2chcoin Core requires some essential build tools and libraries to be installed before.
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, 2chcoin Core should be built with a non-executable stack
...
Disable-wallet mode
--------------------
When the intention is to run only a P2P node without a wallet, 2chcoin Core may be compiled in
