...
* 2chcoin.conf: contains configuration settings for 2chcoind or 2chcoin-qt
* 2chcoind.pid: stores the process id of 2chcoind while running
...
* debug.log: contains debug information and general logging generated by 2chcoind or 2chcoin-qt
