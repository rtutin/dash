...
When deployed on testnet, it is required to start with a fresh data directory or call 2chcoin Core with `-reindex-chainstate`.

0.12.3.4 Change log
===================

See detailed [set of changes](https://github.com/2chcoinpay/2chcoin/compare/v0.12.3.3...2chcoinpay:v0.12.3.4).
