...
This document provides guidelines for internationalization of the 2chcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `2chcoin_en.ts` remains unchanged.
