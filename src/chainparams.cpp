...
public:
    CMainParams() {
        ...
        consensus.nSuperblockStartBlock = 16616; // The block at which 12.1 goes live (end of final 12.0 budget cycle)
...
//        consensus.DIP0003EnforcementHash = uint256S("000000000000002d1734087b4c5afc3133e4e1c3e1a89218f62bcd9bb3d17f81");
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // 2chcoin: 1 day
        consensus.nPowTargetSpacing = 150; // 2chcoin: 2.5 minutes
...
// yespower
        genesis = CreateGenesisBlock(1636570024, 305, 0x1f7fffff, 1, 50 * COIN);
//        MineGenesis(genesis, consensus.powLimit, true);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0096dd4800efca237dbd4199ec345b8a87bb49ac876f3cc63ed0705091f02ce4"));
        assert(genesis.hashMerkleRoot == uint256S("0x27ead2b80b2ed434a604636118d221a890442850444cf0581fc1ca09dc8d9369"));
        ...
        chainTxData = ChainTxData{
            0, // * UNIX timestamp of last known number of transactions (Block 1450962)
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1636569624UL, 1170UL, 0x1f7fffff, 1, 50 * COIN);
//         MineGenesis(genesis, consensus.powLimit, true);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x007a55d8b36c3c38d242a8168dff5ca3fbeebef668eb13a10a1afbb54773e23c"));
        assert(genesis.hashMerkleRoot == uint256S("0x27ead2b80b2ed434a604636118d221a890442850444cf0581fc1ca09dc8d9369"));
...
//        vSeeds.emplace_back("testnet-seed.2chcoindot.io"); // Just a static list of stable node(s), only supports x9

        // Testnet 2chcoin addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Testnet 2chcoin script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet 2chcoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet 2chcoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet 2chcoin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
...
public:
    CDevNetParams(bool fHelpOnly = false) {
        ...
        genesis = CreateGenesisBlock(1636569699, 2, 0x207fffff, 1, 50 * COIN);
//         MineGenesis(genesis, consensus.powLimit, true);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x4c3a25c20092b72bffd11d70e0f42f811ea19c43e9983c2fbd505eba1fd039dc"));
        assert(genesis.hashMerkleRoot == uint256S("0x27ead2b80b2ed434a604636118d221a890442850444cf0581fc1ca09dc8d9369"));
...
//        assert(genesis.hashMerkleRoot == uint256S("0xe0028eb9648db56b1ac77cf090b99048a8007e2bb64b68f092c03c7f56a662c7"));
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("2chcoinevo.org",  "devnet-seed.2chcoinevo.org"));
        ...
        checkpointData = (CCheckpointData) {
            {
                { 0, uint256S("0x55ee5572a4497564c471e465ef2a6aa324ee878433f9177d1980203f7f85d5c6")},
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1636569751, 4, 0x207fffff, 1, 50 * COIN);
//         MineGenesis(genesis, consensus.powLimit, true);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x209b81a4dcf5bbe2e5f7526a2948cbba7478589716152b6c7b5b52ef35fea229"));
        assert(genesis.hashMerkleRoot == uint256S("0x27ead2b80b2ed434a604636118d221a890442850444cf0581fc1ca09dc8d9369"));
...
//        assert(genesis.hashMerkleRoot == uint256S("0xe0028eb9648db56b1ac77cf090b99048a8007e2bb64b68f092c03c7f56a662c7"));
        ...
        // Regtest 2chcoin addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest 2chcoin script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest 2chcoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest 2chcoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest 2chcoin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
