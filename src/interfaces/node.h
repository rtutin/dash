...
//! Interface for the src/evo part of a 2chcoin node (2chcoind process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a 2chcoin node (2chcoind process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a 2chcoin node (2chcoind process).
...
//! Top-level interface for a 2chcoin node (2chcoind process).
class Node
{
public:
    virtual ~Node() {}
