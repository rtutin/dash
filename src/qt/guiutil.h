...
/** Utility functions used by the 2chcoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "2chcoin:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load 2chcoin specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a 2chcoin specific theme is activated (light/dark).*/
