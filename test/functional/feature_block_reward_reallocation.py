#!/usr/bin/env python3
# Copyright (c) 2015-2020 The 2chcoin Core developers
...
class BlockRewardReallocationTest(2chcoinTestFramework):
    def set_test_params(self):
        self.set_2chcoin_test_params(2, 1, fast_dip3_enforcement=True)
        self.set_2chcoin_dip8_activation(450)
