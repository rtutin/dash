...
"""Verify that starting 2chcoind with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start 2chcoind with -h for help text")
        ...
        self.log.info("Start 2chcoind with -version for version information")
