...
"""Test the 2chcoin specific ZMQ notification interfaces."""
...
from test_framework.test_framework import (
     2chcoinTestFramework, skip_if_no_bitcoind_zmq, skip_if_no_py3_zmq)
...
class 2chcoinZMQTest (2chcoinTestFramework):
    def set_test_params(self):
        ...
        self.set_2chcoin_test_params(4, 3, fast_dip3_enforcement=True, extra_args=[node0_extra_args, [], [], []])

    def run_test(self):
        # Check that 2chcoind has been built with ZMQ enabled.
        ...
        try:
            ...
            time.sleep(1)
            # Test all 2chcoin related ZMQ publisher
