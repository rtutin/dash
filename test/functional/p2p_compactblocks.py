...
# TestP2PConn: A peer we use to send messages to 2chcoind, and store responses.
...
class CompactBlocksTest(BitcoinTestFramework):
    ...
    # This test actually causes 2chcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that 2chcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for 2chcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # 2chcoind will not send blocktxn responses for blocks whose height is
